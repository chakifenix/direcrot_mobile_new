...
abstract interface class SkudDataSource {
  Future<List<SkudModel>> getAllSkudList(int page, int? passType);
}

class SkudDataSourceImpl implements SkudDataSource {
  @override
  Future<List<SkudModel>> getAllSkudList(int page, int? passType) async {
    try {
      final response = await DioClient.instance
          .get(skud, queryParameters: {'page': page, 'pass_type_id': passType});
