...
class _TechSupportState extends State<TechSupport> {
  ...
  Future<void> _refresh() async {
    Future bloc = context.read<SupportBloc>().stream.first;
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ObrashenieWidget(
                              ticketId: state.ticketList[index].ticketUid,
                              ...
                              createdAt: state.ticketList[index].createdAt,
                            );
                          })),
